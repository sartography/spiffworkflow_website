...
Now let’s add a bit of Python code to execute.
...
Today you learned a great deal about SpiffWorkflow and the new SpiffArena application, but it’s just the tip of the iceberg.
